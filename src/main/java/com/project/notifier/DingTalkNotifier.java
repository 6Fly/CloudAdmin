package com.project.notifier;

import com.project.util.DingTokeUtil;
...
public class DingTalkNotifier extends AbstractStatusChangeNotifier {
    private static final String  DEFAULT_MESSAGE = "#{instance.registration.name} 状态为: #{event.statusInfo.status}";
    ...
    protected Mono<Void> doNotify(InstanceEvent event, Instance instance) {
        return Mono.fromRunnable(() -> restTemplate.postForEntity(DingTokeUtil.getSignUrl(webhookToken), createMessage(event, instance),Void.class));
    }
